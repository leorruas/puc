...
export const informacoesDisciplinas = {
    ...
    "03. Manipulação de Dados SQL": { numero: "05", resumo: "ddl, dml, consultas, joins, transações e controle de privilégios" },
...
const arquivosFallback = [
    ...
    "03. Manipulação de Dados SQL/03. Manipulação de Dados SQL - Resumo.md",
    "03. Manipulação de Dados SQL/Prompts de Estudo (LLM).md",
