...
Em termos simples: um requisito é a representação clara de uma **necessidade de negócio ou de usuário** traduzida de forma que a equipe técnica possa projetar, codificar (no [[05. Desenvolvimento Web Back-End/05. Desenvolvimento Web Back-End - Resumo|Back-End]] ou Front-End) e testar a solução.
 ...
 * **requisito não-funcional (RNF-01 - desempenho):** *"A busca e notificação dos motoristas deve ocorrer em no máximo 3 segundos."* (Refletindo no estudo de [[04. Algoritmos e Estruturas de Dados/04. Algoritmos e Estruturas de Dados - Resumo|Complexidade de Algoritmos]]).
