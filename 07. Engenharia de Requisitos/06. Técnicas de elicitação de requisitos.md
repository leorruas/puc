...
## Elicitação como descoberta e investigação de necessidades
...
### Elicitar é investigar, não apenas coletar
...
## Da elicitação à validação no ciclo de requisitos
...
```mermaid
flowchart LR
    Elicitacao["Elicitação<br>descobrir e investigar necessidades"]:::core
    Modelagem["Modelagem<br>estruturar e representar requisitos"]:::component
    Validacao["Verificação e validação<br>avaliar qualidade e aderência"]:::data

    Elicitacao --> Modelagem
    Modelagem --> Validacao
```
...
## Técnicas fundamentais de elicitação
...
### Etnografia e observação (*shadowing*)
...
### Workshops e sessões JAD (*Joint Application Development*)
...
### Elicitação baseada em personas
...
## Comparação entre técnicas de elicitação
