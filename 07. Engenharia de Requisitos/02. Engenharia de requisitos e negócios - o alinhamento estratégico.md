...
> **Contexto:** Análise do papel da Engenharia de Requisitos no alinhamento estratégico, a atuação do Analista de Negócios (BA) e do PO, o cálculo de ROI e a prevenção do *gold plating* e do escopo desalinhado.

---

## Requisitos como ponte entre estratégia e software
...
## Do valor de negócio aos requisitos implementáveis
...
```mermaid
flowchart LR
    Estrategia["Estratégia de negócio<br>objetivos e valor"]:::external
    Requisitos["Engenharia de requisitos<br>tradução e alinhamento"]:::core
    Solucao["Código e arquitetura<br>solução implementada"]:::component
...
## Analista de Negócios e Product Owner no alinhamento
...
## Consequências do desalinhamento entre negócio e solução
...
### *Gold plating*: construir além do valor necessário
...
### Solução tecnicamente correta para o problema errado
...
## Práticas para manter o alinhamento estratégico
...
## Requisitos como mecanismo de decisão de produto
