...
flowchart TD
    ...
    subgraph Sistema["Fronteira do sistema: E-commerce"]
        UC01(["UC01: Consultar saldo"]):::component
        UC02(["UC02: Efetuar compra"]):::core
        UC03(["UC03: Aplicar cupom<br>de desconto"]):::component
        UC04(["UC04: Validar token<br>de segurança"]):::component
        UC05(["UC05: Solicitação<br>atendimento VIP"]):::component
    end
...
#### A analogia fundamental: o `«extend»` é o tratamento de exceção (`try-catch`) e desvio condicional (`if`)
