...
## Requisitos descrevem comportamento, qualidade e restrições
...
## Requisitos funcionais: comportamentos e serviços do sistema
...
### Como reconhecer um requisito funcional
...
## Requisitos não funcionais: qualidades e restrições da solução
...
### Categorias e exemplos de requisitos não funcionais
...
## Taxonomia de Sommerville para requisitos não funcionais
...
```mermaid
flowchart TD
    RNF["Requisitos não funcionais"]:::core
    Produto["Produto<br>desempenho, memória, usabilidade"]:::component
    Organizacao["Organizacionais<br>padrões, processos e entregas"]:::component
    Externos["Externos<br>legislação, ética e regulações"]:::external
...
## Diferenciando RF e RNF em situações práticas
...
## Comparação entre requisitos funcionais e não funcionais
