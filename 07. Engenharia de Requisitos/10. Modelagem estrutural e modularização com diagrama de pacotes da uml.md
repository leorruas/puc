...
## Pacotes como organização estrutural de elementos UML
...
## Pacotes, dependências e estereótipos
...
```mermaid
flowchart LR
    subgraph Apresentacao["Pacote: Apresentação"]
        direction TB
        ClienteController["ClienteController"]:::external
        PedidoController["PedidoController"]:::external
    end

    subgraph Dominio["Pacote: Domínio"]
        direction TB
        Cliente["Cliente"]:::core
        Pedido["Pedido"]:::core
        ItemPedido["ItemPedido"]:::component
        CalculadorDesconto["CalculadorDesconto"]:::component
    end

    subgraph Dados["Pacote: Dados"]
        direction TB
        ClienteRepository["ClienteRepository"]:::data
        PedidoRepository["PedidoRepository"]:::data
...
#### Estereótipos comuns de dependência
...
## Critérios para agrupar classes em pacotes
...
### Agrupamento por camadas arquiteturais
...
### Agrupamento por domínio ou funcionalidade
...
## Anti-padrões em diagramas de pacotes
...
## Comparação entre abordagens de agrupamento
...
## Superclasse e pacote resolvem problemas diferentes
...
### Relação entre hierarquia de tipos e organização modular
...
### Quando usar superclasse ou pacote
...
### Diagrama de pacotes e namespaces em C#
...
## Modularização estrutural como apoio à arquitetura
