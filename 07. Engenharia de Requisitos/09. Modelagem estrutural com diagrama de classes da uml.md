...
### 4.1 Como identificar no texto dos requisitos funcionais o que vira classe abstrata, herança ou interface
...
#### 1. Como saber se é uma relação de herança (generalização / especialização)?
...
#### 2. Como saber se a superclasse deve ser abstrata (`{abstract}`)?
* **Pistas textuais no requisito funcional:**
...
#### 3. Como saber se deve ser uma interface (`«interface»`)?
* **Pistas textuais no requisito funcional:**
...
#### Resumo prático de decisão a partir dos requisitos:
...
### 4.2 Ponte interdisciplinar: do Diagrama de Classes da UML para a Programação Modular em C#
