...
> **Contexto:** Conceito formal de requisito segundo o padrão IEEE, hierarquia de abstração (Negócio, Usuário e Sistema) e os 7 atributos de qualidade de um requisito de software com exemplo prático.

---

## Requisito como especificação de uma necessidade
...
## Definição formal e papel do requisito
...
## Do objetivo de negócio ao comportamento do sistema

Nem todos os requisitos possuem o mesmo nível de detalhamento. Eles se organizam em três níveis principais de abstração:

```mermaid
flowchart TD
    Negocio["Requisitos de negócio<br>por que a organização precisa mudar"]:::external
    Usuario["Requisitos de usuário<br>o que o usuário precisa alcançar"]:::component
    Sistema["Requisitos de sistema<br>o que a solução deve oferecer"]:::core
    RF["Requisitos funcionais<br>comportamentos e serviços"]:::data
    RNF["Requisitos não funcionais<br>qualidades e restrições"]:::data
...
## Exemplo integrado: serviço de transporte ou entrega
...
## Requisitos como cadeia de rastreabilidade
...
* INSTITUTE OF ELECTRICAL AND ELECTRONICS ENGINEERS. **IEEE Std 610.12-1990: IEEE Standard Glossary of Software Engineering Terminology**. New York: IEEE, 1990.
