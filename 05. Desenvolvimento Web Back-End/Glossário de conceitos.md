...
O glossário não antecipa tópicos apenas porque costumam aparecer em cursos de back-end. Conceitos como API REST, endpoint, middleware, rota, MVC, ORM, autenticação por token e outros serão adicionados quando efetivamente aparecerem nas aulas, exercícios ou artigos da disciplina.
