...
| **Resposta HTTP** | Mensagem enviada pelo servidor após processar uma requisição. | Pode conter HTML, JSON, CSS, JavaScript, imagem, PDF ou outros tipos de conteúdo. | [[05. Desenvolvimento Web Back-End/01. Arquitetura de software e cliente-servidor\|Artigo 01]] |
...
| **Conteúdo estático** | Recurso que já existe pronto e pode ser enviado ao cliente sem ser gerado a partir de uma regra específica da requisição. | Exemplos comuns incluem imagens, arquivos CSS e outros arquivos. | [[05. Desenvolvimento Web Back-End/01. Arquitetura de software e cliente-servidor\|Artigo 01]] |
| **Conteúdo dinâmico** | Conteúdo produzido pela aplicação a partir da requisição, do estado do sistema ou de dados armazenados. | Pode resultar em HTML, JSON ou outros formatos. | [[05. Desenvolvimento Web Back-End/01. Arquitetura de software e cliente-servidor\|Artigo 01]] |


| **Endereço IP** | Identificador de uma interface de rede usado para localizar uma máquina ou destino em uma rede IP. | No modelo mental da aula, funciona como o “endereço” da máquina; a porta identifica um ponto de comunicação dentro dela. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **Porta** | Ponto lógico de comunicação identificado por um número. | HTTP usa 80 por padrão e HTTPS 443, mas aplicações podem utilizar outras portas. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **TCP** | Protocolo de transporte orientado a conexão e confiável. | HTTP/1.1 e HTTP/2 são tradicionalmente transportados sobre TCP; HTTP/3 utiliza QUIC sobre UDP. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **DOM** | Representação em memória da estrutura de um documento Web como uma árvore de nós e objetos. | JavaScript pode manipular o DOM para alterar estrutura, conteúdo e estilo sem trocar o documento inteiro. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **Renderização** | Processo de transformar código, componentes e dados em uma interface apresentada ao usuário. | Pode ocorrer no cliente, no servidor ou antecipadamente durante o build. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **Template** | Modelo de interface com estrutura fixa e partes preenchidas dinamicamente. | Pode ser processado no servidor ou por ferramentas de geração conforme a arquitetura. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
...
| **Topologia** | Forma como nós, serviços ou componentes estão dispostos e conectados. | Não é sinônimo de tier: tier indica separação física ou de implantação. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **MPA** | Aplicação de múltiplas páginas em que a navegação principal normalmente solicita novos documentos ao servidor. | Pode usar JavaScript e atualizações assíncronas sem deixar de ser MPA. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **SPA** | Aplicação que mantém um documento principal e atualiza a interface durante a navegação. | Não é sinônimo de CSR: uma SPA pode receber HTML inicial via SSR e depois continuar no cliente. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **AJAX** | Técnica de realizar requisições assíncronas e atualizar partes da página sem recarregamento completo. | O termo nasceu ligado a XMLHttpRequest; hoje Fetch e abstrações de frameworks são comuns. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **Fetch API** | API moderna do navegador para realizar requisições HTTP programaticamente. | É uma alternativa moderna ao XMLHttpRequest para muitos casos de comunicação assíncrona. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **CSR** | Estratégia em que a interface é renderizada principalmente no navegador. | Muito associada a SPAs, mas não é sinônimo de SPA. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **SSR** | Estratégia em que o servidor produz HTML em resposta a uma requisição. | Pode ser usado tanto em modelos tradicionais quanto em aplicações modernas que depois hidratam no cliente. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **SSG** | Estratégia em que páginas HTML são pré-geradas antes da requisição do usuário, geralmente durante o build. | É adequada quando o conteúdo pode ser conhecido antecipadamente; não é sinônimo de Next.js. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **Hidratação** | Processo pelo qual JavaScript adiciona estado e interatividade a HTML previamente renderizado. | Permite combinar HTML inicial do servidor com comportamento interativo no cliente. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **API** | Interface que expõe operações ou dados para que outro software possa utilizá-los. | Em SPAs, o backend frequentemente fornece dados por APIs enquanto o cliente decide como apresentá-los. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
| **SEO** | Conjunto de práticas para favorecer descoberta, rastreamento e compreensão de páginas por mecanismos de busca. | CSR pode exigir cuidados adicionais; Google executa JavaScript, mas SSR e pré-renderização continuam úteis. | [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização\|Artigo 03]] |
