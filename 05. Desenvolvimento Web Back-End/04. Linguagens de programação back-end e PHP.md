...
> **Contexto:** Este artigo explica o papel das linguagens de programação no back-end usando PHP como estudo de caso. A análise inclui modelo de execução, sistema de tipos, integração com servidor Web, acesso a dados e templates, sem tratar PHP como a única forma de desenvolver no servidor.

**Artigo anterior:** [[05. Desenvolvimento Web Back-End/03. Tipos de aplicações Web e estratégias de renderização|Tipos de aplicações Web e estratégias de renderização]]
