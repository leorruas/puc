...
| `05` | **[[05. Desenvolvimento Web Back-End/00. Desenvolvimento Web Back-End - Resumo\|Desenvolvimento Web Back-End]]** | Arquitetura, estilos e tipos de aplicações Web | Inicial (3 artigos + glossário) | Em andamento inicial | **Em estudo** | Anotações consolidadas sobre arquitetura, layers vs. tiers, monólito, cliente-servidor, MPA/SPA, CSR/SSR/SSG, DOM e comunicação Web; dúvidas de aula transformadas em distinções conceituais e exercício da PUC revisado criticamente. |
