...
| `03` | **[[03. Manipulação de Dados SQL/00. Manipulação de Dados SQL - Resumo\|Manipulação de dados com SQL]]** | Fundamentos de SQL, estrutura relacional, SGBDs e DDL | Inicial (4 artigos + glossário) | Em andamento inicial | **Em estudo** | Artigos 01 a 04 consolidados: fundamentos da linguagem, estrutura relacional, SGBDs, criação de bancos/tabelas e alteração de estruturas com `ALTER TABLE`, `DROP TABLE`, `TRUNCATE TABLE` e renomeação. |
