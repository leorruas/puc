...
| `05` | **[[05. Desenvolvimento Web Back-End/00. Desenvolvimento Web Back-End - Resumo\|Desenvolvimento Web Back-End]]** | Arquitetura de software, cliente-servidor e estilos arquiteturais | Inicial (2 artigos) | Em andamento inicial | **Em estudo** | Anotações consolidadas sobre arquitetura, atributos de qualidade, layers vs. tiers, cliente-servidor e monólito; exercício da PUC revisado com distinção entre simplificação didática e ressalva técnica. |
