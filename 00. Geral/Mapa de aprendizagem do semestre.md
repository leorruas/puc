...
| `03` | **[[03. Manipulação de Dados SQL/00. Manipulação de Dados SQL - Resumo\|Manipulação de dados com SQL]]** | Fundamentos de SQL, estrutura relacional, SGBDs, DDL e DML | Inicial (5 artigos + glossário) | Em andamento inicial | **Em estudo** | Artigos 01 a 05 consolidados: fundamentos da linguagem, estrutura relacional, criação/alteração de tabelas e manipulação de linhas com `INSERT`, `UPDATE` e `DELETE`, incluindo `NULL`, `DEFAULT` e uso de `WHERE`. |
