...
| `03` | **[[03. Manipulação de Dados SQL/00. Manipulação de Dados SQL - Resumo\|Manipulação de dados com SQL]]** | Fundamentos de SQL, estrutura relacional, SGBDs, DDL, DML, consultas, transações e DCL | Inicial (13 artigos + glossário) | Em andamento | **Em estudo** | Artigos 01 a 13 consolidados: fundamentos, manipulação, filtros, agregações, agrupamento, `JOIN`/`UNION`, subconsultas, transações e controle de privilégios com `GRANT`/`REVOKE`. |
