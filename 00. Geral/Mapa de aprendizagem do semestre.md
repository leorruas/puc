...
| `05` | **[[05. Desenvolvimento Web Back-End/00. Desenvolvimento Web Back-End - Resumo\|Desenvolvimento Web Back-End]]** | Arquitetura, renderização, frameworks e persistência | Inicial (5 artigos + glossário) | Em andamento inicial | **Em estudo** | Cobertura ampliada para frameworks Web, MVC e ORM com Entity Framework Core, conectando classes C#, relações 1:N e migrations ao modelo relacional; fluxo equivalente para macOS documentado sem alterar o estado de aprendizagem. |
