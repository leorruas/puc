...
| `06` | **[[06. Projeto - Aplicacao Interativa/00. Projeto - Aplicacao Interativa - Resumo\|Projeto: Aplicação Interativa]]** | Etapas 01 (Concepção) e 02 (Arquitetura e Modelagem) | Robusta (Resumos e 5 reuniões transcritas) | Em andamento (Etapa 02) | **Em estudo** | Etapa 01 entregue (ODS 4, 3 CRUDs e casos de uso validados); Etapa 02 em modelagem ativa (MER/DER, SQL Server, fluxo e planos de teste). |
