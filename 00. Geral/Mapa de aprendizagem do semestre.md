...
| `03` | **[[03. Manipulacao de Dados SQL/00. Manipulacao de Dados SQL - Resumo\|Manipulação de dados com SQL]]** | Fundamentos de SQL, estrutura relacional, SGBDs e DDL | Inicial (3 artigos + glossário) | Em andamento inicial | **Em estudo** | Artigos 01 a 03 consolidados: linguagem declarativa, DDL/DML/DQL/DCL, estrutura relacional, SGBD, cliente-servidor, distinção entre sentidos de domínio e criação prática de bancos/tabelas com `CREATE DATABASE`, `USE`, `CREATE TABLE` e `PRIMARY KEY`. |
