...
| `03` | **[[03. Manipulação de Dados SQL/00. Manipulação de Dados SQL - Resumo\|Manipulação de dados com SQL]]** | Fundamentos de SQL, estrutura relacional, SGBDs, DDL, DML e consultas | Inicial (11 artigos + glossário) | Em andamento | **Em estudo** | Artigos 01 a 11 consolidados: fundamentos, manipulação, filtros, agregações, agrupamento, `JOIN`/`UNION` e subconsultas sem/com correlação com `IN`, `ANY`, `ALL` e `EXISTS`. |
