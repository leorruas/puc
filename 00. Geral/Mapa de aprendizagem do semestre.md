...
| `05` | **[[05. Desenvolvimento Web Back-End/00. Desenvolvimento Web Back-End - Resumo\|Desenvolvimento Web Back-End]]** | Arquitetura, renderização e linguagens back-end | Inicial (4 artigos + glossário) | Em andamento inicial | **Em estudo** | Anotações consolidadas sobre arquitetura, MPA/SPA, CSR/SSR/SSG, comunicação Web e PHP; distinções entre compilação/interpretação, tipagem estática/dinâmica e papéis de servidor Web, runtime e banco de dados foram incorporadas criticamente às notas. |
