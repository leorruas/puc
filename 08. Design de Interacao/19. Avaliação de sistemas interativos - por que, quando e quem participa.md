...
| Pergunta | Decisão que orienta |
| :--- | :--- |
| Por que avaliar? | Objetivos, hipóteses e critérios de sucesso |
| Quando avaliar? | Momento do ciclo de vida e maturidade do artefato |
| Quem participa? | Perfis de usuários, especialistas e demais stakeholders envolvidos |
...
| Tipo | Momento | Finalidade principal |
| :--- | :--- | :--- |
| Formativa | Durante concepção e desenvolvimento | Identificar problemas e orientar mudanças |
| Somativa | Em solução mais madura ou final | Medir resultados e verificar metas de qualidade |
...
| Família de método | Fonte principal de evidência |
| :--- | :--- |
| Inspeção | Especialistas analisam a interface com critérios ou modelos |
| Observação | Comportamento de usuários durante tarefas |
| Investigação | Relatos dos usuários por entrevistas, questionários ou instrumentos semelhantes |
...
| Perspectiva | Eixo de comparação |
| :--- | :--- |
| Longitudinal | Mudanças ao longo do tempo |
| Latitudinal / transversal | Comparação entre unidades ou grupos em um mesmo recorte |
| Altitudinal | Comparação entre níveis hierárquicos ou camadas de análise |
