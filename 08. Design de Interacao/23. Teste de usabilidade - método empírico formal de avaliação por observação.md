...
O **teste de usabilidade** é um método empírico de avaliação no qual **usuários reais** utilizam o sistema para realizar **tarefas pré-definidas**, enquanto uma equipe de avaliadores observa e coleta dados qualitativos e quantitativos sobre a interação.
