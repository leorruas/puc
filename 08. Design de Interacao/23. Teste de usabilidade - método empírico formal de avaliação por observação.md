...
| **Mapa de calor de cliques (*Click Heatmap*)** | Manchas de calor formadas pelos cliques do mouse ou toques na tela (medidos via software). | Diferenciar o que o usuário **olhou** (rastreamento ocular) do que ele efetivamente **clicou** (rastreamento de eventos). |

---

## 7. Medição e avaliação no teste de usabilidade
...
## 7. Quantos participantes são necessários? (A regra dos 5 usuários)
...
## 8. Matriz resumida das fases e entregáveis do Teste de Usabilidade
