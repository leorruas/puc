...
## Modelos de usuário transformam pesquisa em referências para o design
...
## Usuários precisam ser descritos de forma específica e contextual

### Usuários específicos na ISO 9241-11
...
```mermaid
flowchart TD
    Usuario["Usuários específicos"]:::external
    Objetivos["Objetivos específicos"]:::component
    Contexto["Contexto de uso específico"]:::component
    Uso["Qualidade em uso<br>eficácia, eficiência e satisfação"]:::core
...
## Perfil de usuário sintetiza características de um grupo
...
```mermaid
flowchart LR
    Pesquisa["Pesquisa empírica<br>questionários, logs e censos"]:::external
    Sintese["Agregação e síntese dos dados"]:::component
    Perfil["Perfil de usuário<br>visão panorâmica do grupo"]:::core
...
## Persona representa padrões de comportamento e objetivos
...
```mermaid
flowchart LR
    Pesquisa["Pesquisa qualitativa<br>e quantitativa"]:::external
    Padroes["Padrões de comportamento<br>objetivos e necessidades"]:::component
    Persona["Persona<br>arquétipo fundamentado"]:::core
    Decisoes["Decisões de design"]:::data
...
### Tipos de persona em um projeto
...
## Mapa de empatia organiza percepções sobre experiência e contexto
...
| Dimensão do mapa de empatia | Pergunta orientadora |
| :--- | :--- |
| Vê | O que aparece no ambiente e no cotidiano da pessoa? |
| Ouve | Que mensagens, pessoas e influências chegam até ela? |
| Pensa e sente | Quais preocupações, expectativas e emoções são relevantes? |
| Fala e faz | Como se comporta e se expressa em situações observáveis? |
| Dores | Quais frustrações, medos e obstáculos enfrenta? |
| Ganhos | Quais resultados, desejos e necessidades busca? |

### Seis dimensões do mapa de empatia
...
## Comparação entre perfil, persona e mapa de empatia
...
## Personas conectam pesquisa, projeto integrador e requisitos

A modelagem de personas e perfis de usuário não é restrita à teoria de Design de Interação; ela é a base prática para o desenvolvimento de software no curso:

1. **Aplicação Prática no Projeto Integrador (Etapa 01):**
   * As diretrizes de escopo do projeto da PUC Minas exigem a definição obrigatória de **5 personas completas** e **2 histórias de usuário por persona** (totalizando 10 histórias de usuário), conforme documentado em [[06. Projeto - Aplicacao Interativa/02. Requisitos e diretrizes de escopo do projeto.md|Requisitos e Diretrizes de Escopo do Projeto]].
2. **Elicitação de Requisitos de Software:**
   * Na [[07. Engenharia de Requisitos/06. Técnicas de elicitação de requisitos.md|Engenharia de Requisitos]], as personas atuam como os **Atores primários e secundários** nos Diagramas de Casos de Uso, garantindo que os requisitos funcionais reflitam as reais dores e objetivos dos usuários finais.

---

## Modelos de usuário apoiam decisões sem substituir pesquisa empírica
