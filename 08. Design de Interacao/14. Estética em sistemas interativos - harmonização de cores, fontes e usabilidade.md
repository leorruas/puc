...
```mermaid
flowchart LR
    Estetica["Interface percebida como<br>esteticamente agradável"]:::component
    Afeto["Pode favorecer afeto positivo<br>e reduzir tensão percebida"]:::data
    Percepcao["Pode elevar a percepção<br>de facilidade e qualidade"]:::core
    Tolerancia["Pode aumentar a tolerância<br>a pequenos atritos de uso"]:::external

    Estetica --> Afeto
    Afeto --> Percepcao
    Percepcao --> Tolerancia
```
...
| Esquema cromático | Relação entre cores |
| :--- | :--- |
| Monocromático | Variações de uma mesma matiz |
| Análogo | Cores vizinhas no círculo cromático |
...
| Decisão tipográfica | Finalidade |
| :--- | :--- |
| Hierarquia de tamanhos | Distinguir título, subtítulo e corpo |
| Altura de linha | Favorecer leitura contínua e separação visual |
| Comprimento da linha | Evitar linhas excessivamente curtas ou longas |
| Pareamento de fontes | Criar contraste sem fragmentar a identidade visual |
