...
## Avaliar acessibilidade exige verificar barreiras reais de percepção e operação
...
## W3C, WAI e WCAG estruturam referências para acessibilidade Web
...
flowchart LR
    W3C["W3C"]:::external
    WAI["Web Accessibility Initiative"]:::component
    WCAG["WCAG"]:::core
    Avaliacao["Avaliação de conformidade<br>e barreiras de acessibilidade"]:::data
...
## WCAG organiza acessibilidade pelos princípios POUR
...
| Princípio WCAG | Pergunta de projeto |
| :--- | :--- |
| Percebível | A informação pode ser percebida por diferentes usuários e sentidos? |
| Operável | A interface pode ser operada por diferentes formas de entrada e navegação? |
| Compreensível | Conteúdo e comportamento são claros e previsíveis? |
| Robusto | O conteúdo permanece interpretável por diferentes agentes e tecnologias assistivas? |

### Percebível, operável, compreensível e robusto
...
## Níveis A, AA e AAA expressam critérios de conformidade
...
## Avaliação automatizada, inspeção manual e testes com tecnologias assistivas
...
| Método | O que consegue verificar melhor | Limitação principal |
| :--- | :--- | :--- |
| Avaliação automatizada | Erros detectáveis por regras de código e padrões verificáveis | Não compreende toda a experiência nem todos os critérios |
| Inspeção manual | Teclado, foco, semântica, ordem de leitura e aspectos contextuais | Depende de conhecimento especializado e cobertura sistemática |
| Testes com tecnologias assistivas e usuários | Barreiras reais durante tarefas e estratégias de uso | Exige recrutamento, planejamento e interpretação contextual |
...
## Comparação entre métodos de avaliação de acessibilidade
...
## Conformidade técnica e experiência acessível precisam ser avaliadas em conjunto
