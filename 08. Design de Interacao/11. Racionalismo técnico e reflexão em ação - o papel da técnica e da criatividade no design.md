...
```mermaid
flowchart LR
    Problema["Problema definido"]:::external
    Metodo["Regras, modelos e técnicas"]:::component
    Processo["Aplicação sistemática"]:::core
    Solucao["Solução resultante"]:::data
...
```mermaid
flowchart LR
    Situacao["Situação ambígua<br>*wicked problem*"]:::external
    Enquadrar["Enquadrar o problema"]:::core
    Agir["Agir / experimentar"]:::component
    Resposta["Observar a resposta da situação"]:::data
    Refletir["Refletir durante a ação"]:::component

    Situacao --> Enquadrar
    Enquadrar --> Agir
    Agir --> Resposta
    Resposta --> Refletir
    Refletir -->|"reformula hipóteses"| Enquadrar
```
...
```mermaid
flowchart TD
    Tecnica["Técnica<br>normas, heurísticas e padrões"]:::data
    Criatividade["Reflexão e criatividade<br>framing, empatia e experimentação"]:::component
    Design["Design de interação<br>decisões situadas e fundamentadas"]:::core
