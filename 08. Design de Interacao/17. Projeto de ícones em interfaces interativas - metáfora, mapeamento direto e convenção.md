...
```mermaid
graph LR
    Conceito["Conceito / Função de software"] --> Signo["Representação pictórica (Ícone)"]
    Signo --> Reconhecimento["Reconhecimento visual imediato"]
    Reconhecimento --> Ação["Execução de comando pelo usuário"]
```
