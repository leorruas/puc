...
```mermaid
graph TD
    Projeto["Estratégias de projeto de ícones"] --> Metafora["1. Metáfora<br>(Transferência de outro domínio)"]
    Projeto --> Mapeamento["2. Mapeamento direto<br>(Semelhança física com a função)"]
...
```mermaid
graph TD
    Diretrizes["Diretrizes de usabilidade para ícones"] --> D1["1. Acompanhar de rótulos de texto<br>(Icon + Label)"]
    Diretrizes --> D2["2. Manter consistência familiar<br>no Design System"]
    Diretrizes --> D3["3. Fornecer Dicas de Ferramenta<br>(Tooltips em desktop)"]
    Diretrizes --> D4["4. Garantir área de clique/toque adequada<br>(44x44px em mobile)"]
