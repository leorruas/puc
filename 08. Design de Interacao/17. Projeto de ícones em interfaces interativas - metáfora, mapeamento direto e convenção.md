...
## Ícones condensam ações e conceitos em signos visuais
...
## Ícones apoiam reconhecimento, economia de espaço e orientação
...
```mermaid
flowchart LR
    Conceito["Conceito ou função"]:::external
    Icone["Ícone"]:::core
    Interpretacao["Reconhecimento e interpretação"]:::component
    Acao["Ação do usuário"]:::data
...
### O risco da navegação por adivinhação
...
## Metáfora, mapeamento direto e convenção
...
| Estratégia | Como produz significado | Exemplo conceitual |
| :--- | :--- | :--- |
| Metáfora | Transfere significado de outro domínio | Lixeira para excluir |
| Mapeamento direto | Representa visualmente o próprio objeto ou ação | Lupa para ampliar ou buscar, conforme o contexto |
| Convenção | Usa um significado aprendido e socialmente estabilizado | Símbolo de energia para ligar/desligar |
...
## Ícones também operam como signos
...
## Diretrizes de usabilidade para ícones
...
| Diretriz | Objetivo |
| :--- | :--- |
| Combinar ícone e rótulo quando necessário | Reduzir ambiguidade |
| Manter consistência no sistema visual | Facilitar aprendizagem e reconhecimento |
| Oferecer ajuda contextual quando apropriado | Apoiar interpretação de símbolos menos familiares |
| Garantir área de interação adequada | Melhorar precisão de clique ou toque |
| Preservar contraste e distinção entre estados | Apoiar percepção e acessibilidade |
...
## Comparação entre estratégias de representação
...
## Bons ícones combinam significado, convenção e contexto
...
- **Próximo artigo:** [[18. Princípios e regras de design - psicologia da gestalt e regras de ouro]]
