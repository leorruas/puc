...
## Interação depende de objetivo, contexto e interface
...
## Objetivo, contexto, interface e interação
...
## Cultura também faz parte do contexto de uso
...
### Fatores culturais que afetam interfaces
...
## IHC combina diferentes disciplinas para compreender a interação
...
## Papéis de design convergem no design centrado no usuário
...
### Convergência entre estratégia, estrutura, comportamento e apresentação
...
### Analogia da residência para os papéis de design
...
## Exemplo integrado: aplicativo de entrega em contexto global
...
## Contexto e multidisciplinaridade conectam as decisões de design
