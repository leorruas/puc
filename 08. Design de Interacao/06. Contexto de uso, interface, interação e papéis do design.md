...
```mermaid
flowchart TD
    UCD["Design centrado no usuário<br>experiência coerente e útil"]:::core
    UX["UX<br>estratégia, pesquisa e jornada"]:::component
    IA["Arquitetura da Informação<br>estrutura, navegação e rotulagem"]:::data
    IxD["Design de Interação<br>fluxos, estados e comportamento"]:::component
    UI["UI<br>apresentação visual e componentes"]:::data
