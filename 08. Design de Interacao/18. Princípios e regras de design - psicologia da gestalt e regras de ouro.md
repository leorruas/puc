...
## Princípios perceptivos e regras de interação orientam decisões diferentes
...
## Gestalt explica como elementos visuais são percebidos em conjunto
...
| Princípio gestáltico | Efeito perceptivo relevante para UI |
| :--- | :--- |
| Proximidade | Elementos próximos tendem a ser percebidos como grupo |
| Boa continuidade | Alinhamentos e trajetórias favorecem continuidade visual |
| Simetria | Formas equilibradas tendem a ser percebidas como pertencentes ao mesmo conjunto |
| Similaridade | Elementos parecidos tendem a ser associados |
| Destino comum | Elementos que se movem na mesma direção tendem a ser agrupados |
| Fechamento | A percepção completa formas mesmo quando há partes ausentes |
| Região comum | Elementos dentro de uma mesma área tendem a formar grupo |
| Conectividade | Elementos visualmente conectados tendem a ser percebidos como relacionados |

### Princípios gestálticos aplicados à interface
...
## Regras de Ouro de Shneiderman orientam o comportamento da interface
...
| Regra de Ouro de Shneiderman | Intenção de design |
| :--- | :--- |
| Buscar consistência | Tornar padrões previsíveis |
| Atender à usabilidade universal e oferecer atalhos | Apoiar usuários com diferentes níveis de experiência |
| Oferecer feedback informativo | Tornar consequências das ações perceptíveis |
| Projetar diálogos com fechamento | Dar sensação de conclusão às sequências de ação |
| Prevenir erros | Reduzir falhas e facilitar correção |
| Permitir reversão de ações | Apoiar exploração e recuperação |
| Manter o usuário no controle | Evitar comportamentos inesperados ou arbitrários |
| Reduzir carga de memória de curto prazo | Manter informação necessária visível ou facilmente acessível |
...
## Gestalt e Regras de Ouro atuam em níveis diferentes
...
## Percepção visual e comportamento interativo devem ser projetados em conjunto
