...
| Método | Natureza | Evidência principal |
| :--- | :--- | :--- |
| MIS | Inspeção analítica | Signos e metamensagem reconstruída por especialistas |
| MAC | Avaliação empírica | Rupturas de comunicação observadas durante o uso |
...
```mermaid
flowchart LR
    Estaticos["1. Analisar signos estáticos"]:::component
    Dinamicos["2. Analisar signos dinâmicos"]:::component
    Metaling["3. Analisar signos metalinguísticos"]:::component
    Metamensagem["4. Reconstruir a metamensagem"]:::core
    Avaliar["5. Avaliar a comunicabilidade"]:::data

    Estaticos --> Dinamicos
    Dinamicos --> Metaling
    Metaling --> Metamensagem
    Metamensagem --> Avaliar
```
...
```mermaid
flowchart LR
    Preparacao["1. Preparação<br>perfil, tarefas e gravação"]:::external
    Teste["2. Teste de uso<br>com usuários"]:::component
    Etiquetagem["3. Etiquetagem<br>das rupturas"]:::core
    Diagnostico["4. Consolidação e diagnóstico<br>falhas e recomendações"]:::data

    Preparacao --> Teste
    Teste --> Etiquetagem
    Etiquetagem --> Diagnostico
```
