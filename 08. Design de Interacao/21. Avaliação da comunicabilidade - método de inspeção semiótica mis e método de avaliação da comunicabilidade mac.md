...
```mermaid
graph TD
    MIS["Etapas do Método de Inspeção Semiótica (MIS)"] --> E1["1. Análise dos signos estáticos<br>(Layout, rótulos e elementos visuais fixos)"]
    MIS --> E2["2. Análise dos signos dinâmicos<br>(Comportamento, respostas e transições de tela)"]
    MIS --> E3["3. Análise dos signos metalinguísticos<br>(Documentação, ajuda, tutoriais e mensagens de erro)"]
    
    E1 --> S3["4. Reconstrução da meta-mensagem do designer"]
    E2 --> S3
    E3 --> S3
    
    S3 --> E5["5. Avaliação da comunicabilidade<br>(Julgamento de coerência e qualidade da mensagem)"]
```
...
### As 5 etapas de execução do MIS

1. **Análise dos signos estáticos:** o avaliador examina os componentes visuais fixos de cada tela.
2. **Análise dos signos dinâmicos:** o avaliador executa os fluxos de tarefa para observar como os signos mudam no tempo.
3. **Análise dos signos metalinguísticos:** o avaliador inspeciona a ajuda e as explicações do sistema.
4. **Reconstrução da meta-mensagem:** o avaliador consolida o aprendizado e escreve a frase de meta-mensagem que o designer parece estar transmitindo.
5. **Avaliação da comunicabilidade:** o avaliador compara as meta-mensagens reconstruídas nas três categorias e julga se a comunicação é consistente, se há contradições ou se faltam informações essenciais para o usuário.
