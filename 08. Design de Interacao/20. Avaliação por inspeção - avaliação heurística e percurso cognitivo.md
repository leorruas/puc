...
## Inspeção permite encontrar problemas sem depender de teste com usuários
...
## Avaliação por inspeção analisa a interface por critérios especializados
...
| Método | Pergunta central |
| :--- | :--- |
| Avaliação Heurística | A interface viola princípios gerais de usabilidade? |
| Percurso Cognitivo | Um usuário iniciante conseguirá descobrir o próximo passo e perceber progresso? |

### Vantagens dos métodos de inspeção
...
## Avaliação Heurística verifica princípios gerais de usabilidade
...
| Heurística de Nielsen | Foco |
| :--- | :--- |
| Visibilidade do estado do sistema | Manter o usuário informado |
| Correspondência entre sistema e mundo real | Usar linguagem e conceitos familiares |
| Controle e liberdade do usuário | Permitir saída, cancelamento e reversão |
| Consistência e padrões | Seguir convenções e manter significados estáveis |
| Prevenção de erros | Evitar problemas antes que ocorram |
| Reconhecer em vez de recordar | Manter opções e informação necessárias visíveis |
| Flexibilidade e eficiência de uso | Apoiar iniciantes e usuários experientes |
| Estética e design minimalista | Evitar informação irrelevante |
| Reconhecer, diagnosticar e recuperar-se de erros | Tornar erros compreensíveis e solucionáveis |
| Ajuda e documentação | Oferecer suporte focado em tarefas quando necessário |
...
```mermaid
flowchart LR
    Preparacao["Preparação<br>escopo, contexto e tarefas"]:::external
    Inspecao["Inspeção individual<br>coleta e interpretação"]:::core
    Consolidacao["Consolidação<br>severidade e recomendações"]:::data

    Preparacao --> Inspecao
    Inspecao --> Consolidacao
```
...
## Percurso Cognitivo investiga aprendizagem por exploração
...
| Pergunta do Percurso Cognitivo | O que verifica |
| :--- | :--- |
| O usuário tentará alcançar o efeito correto? | Se o objetivo do próximo passo é compreensível |
| O usuário perceberá que a ação correta está disponível? | Se o controle necessário é encontrável |
| O usuário associará a ação correta ao efeito desejado? | Se rótulo, ícone ou controle comunica a consequência |
| Após agir, perceberá progresso rumo ao objetivo? | Se o feedback confirma avanço na tarefa |

### Quatro perguntas do Percurso Cognitivo
...
## Comparação entre Avaliação Heurística e Percurso Cognitivo
...
## Os dois métodos inspecionam problemas sob perspectivas complementares
