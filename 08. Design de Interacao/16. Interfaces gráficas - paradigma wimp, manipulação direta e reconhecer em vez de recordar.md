...
## Interfaces gráficas reduzem a distância entre intenção e ação
...
## WIMP organiza a interação por janelas, ícones, menus e apontador
...
| Elemento WIMP | Papel na interação |
| :--- | :--- |
| Windows | Organizar tarefas e conteúdos em áreas independentes |
| Icons | Representar objetos, ações ou estados visualmente |
| Menus | Expor comandos e opções disponíveis |
| Pointer | Permitir seleção e manipulação por apontamento |

### Elementos do paradigma WIMP
...
## Manipulação direta aproxima ação e resultado visível
...
```mermaid
flowchart LR
    Objeto["Representação visual contínua"]:::external
    Acao["Ação direta<br>clique, toque ou arrasto"]:::core
    Feedback["Feedback perceptível"]:::component
    Ajuste["Confirmar, corrigir<br>ou desfazer"]:::data
...
## Reconhecimento reduz a dependência de memória
...
| Processo cognitivo | O que o usuário precisa fazer | Implicação para a interface |
| :--- | :--- | :--- |
| Recordar | Recuperar informação da memória sem pista visível suficiente | Maior dependência de memória |
| Reconhecer | Identificar uma opção, objeto ou pista apresentada | Reduz a necessidade de lembrar comandos ou caminhos |

### Recordar e reconhecer exigem esforços diferentes
...
### Como a interface apoia reconhecimento
...
## Comparação entre linha de comando e interface gráfica
...
## Interfaces gráficas combinam representação, ação e feedback
...
- **Próximo artigo:** [[17. Projeto de ícones em interfaces interativas - metáfora, mapeamento direto e convenção]]
