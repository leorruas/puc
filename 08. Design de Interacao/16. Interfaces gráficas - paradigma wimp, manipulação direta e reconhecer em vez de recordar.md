...
graph TD
    subgraph Memoria ["Memória Cognitiva"]
        Recall["Recordar (Recall)<br>- Busca na memória de longo prazo<br>- Alta carga cognitiva"]
        Recognition["Reconhecer (Recognition)<br>- Identificação visual de pistas<br>- Baixa carga cognitiva"]
    end
```
