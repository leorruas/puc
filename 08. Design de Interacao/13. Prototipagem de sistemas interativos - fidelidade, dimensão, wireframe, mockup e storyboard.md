...
graph TD
    subgraph Escopo ["Dimensões do escopo de prototipagem"]
        H["Prototipagem horizontal (Larga e rasa: cobre<br>muitas telas sem profundidade de dados)"]
        V["Prototipagem vertical (Estreita e profunda:<br>cobre poucas funções com alta funcionalidade)"]
        T["Protótipo em T (Superfície horizontal<br>com verticais pontuais em tarefas críticas)"]
    end
```
