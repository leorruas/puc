...
```mermaid
graph LR
    Ideia["Ideia de design"] --> Protótipo["Manifestação concreta (Protótipo)"]
    Protótipo --> Avaliação["Interação e avaliação empírica"]
...
```mermaid
graph LR
    Cena1["Quadro 1: Usuário enfrenta o problema no trabalho"] --> Cena2["Quadro 2: Abre o sistema no smartphone"]
    Cena2 --> Cena3["Quadro 3: Executa a ação principal"]
    Cena3 --> Cena4["Quadro 4: Problema resolvido com sucesso"]
```
