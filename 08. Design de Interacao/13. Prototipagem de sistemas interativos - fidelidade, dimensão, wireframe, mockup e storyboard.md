...
```mermaid
flowchart LR
    Ideia["Ideia de design"]:::external
    Prototipo["Protótipo"]:::core
    Avaliacao["Interação e avaliação"]:::component
    Feedback["Feedback e aprendizado"]:::data
    Decisao["Refinar, descartar<br>ou explorar alternativa"]:::component
...
| Escopo do protótipo | Característica | Uso típico |
| :--- | :--- | :--- |
| Horizontal | Amplo e pouco profundo | Explorar navegação, arquitetura e cobertura de telas |
| Vertical | Restrito e profundo | Testar uma funcionalidade crítica com maior detalhe |
| Em T | Base horizontal com aprofundamentos pontuais | Combinar visão do conjunto com tarefas críticas detalhadas |
...
```mermaid
flowchart LR
    Cena1["1. Usuário encontra o problema"]:::external
    Cena2["2. Abre o sistema"]:::component
    Cena3["3. Executa a ação principal"]:::core
    Cena4["4. Observa o resultado"]:::data
