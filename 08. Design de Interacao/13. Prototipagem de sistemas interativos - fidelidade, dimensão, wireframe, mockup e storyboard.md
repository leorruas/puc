...
## Protótipos tornam ideias testáveis antes da implementação final
...
## Prototipagem apoia exploração, comunicação e avaliação
...
## Fidelidade define quanto o protótipo se aproxima da solução final
...
### Comparação entre baixa e alta fidelidade
...
## Escopo horizontal, vertical e em T
...
### Wireframe como estrutura da interface
...
### Mockup como representação visual detalhada
...
## Comparação entre storyboard, wireframe e mockup
...
## Prototipagem no Projeto Integrador
...
## Prototipar cedo reduz custo de aprendizado e mudança
