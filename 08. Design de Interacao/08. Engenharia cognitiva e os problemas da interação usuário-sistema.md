...
## Engenharia cognitiva aproxima objetivos humanos e estados do sistema
...
## Engenharia cognitiva como ponte entre mente e sistema
...
## Mundo psicológico e mundo físico usam representações diferentes
...
```mermaid
flowchart LR
    Objetivos["Objetivos e intenções<br>mundo psicológico"]:::external
    Acao["Ações possíveis<br>na interface"]:::component
    Sistema["Controles e estado<br>mundo físico"]:::core
    Percepcao["Percepção e interpretação<br>do resultado"]:::component

    Objetivos -->|"traduz intenção em ação"| Acao
    Acao --> Sistema
    Sistema -->|"torna o estado perceptível"| Percepcao
    Percepcao -->|"avalia em relação ao objetivo"| Objetivos
```

### Variáveis psicológicas do usuário
...
### Variáveis e controles do sistema
...
### Traduzir entre objetivos e mecanismos do sistema
...
## As sete etapas da ação de Donald Norman
...
## Princípios de design reduzem os golfos
...
## Exemplo integrado: upload de arquivos em nuvem
...
## Boa interação reduz o esforço de tradução entre intenção e estado
