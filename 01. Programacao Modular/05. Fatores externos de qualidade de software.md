...
| **Eficiência** | *"O app abre rápido e não esquenta o celular?"* | O usuário desinstala o app por ser pesado e lento. |
| **Facilidade de Uso** | *"Consigo usar sem precisar de treinamento complexo?"* | O usuário comete erros frequentes, desiste do sistema ou sobrecarrega o suporte. |
