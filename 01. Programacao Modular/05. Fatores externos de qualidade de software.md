...
```mermaid
flowchart LR
    Internos["Qualidade interna<br>estrutura e código"]:::data
    Externos["Qualidade externa<br>efeitos percebidos no uso"]:::core
...
| Fator externo | Pergunta central |
| :--- | :--- |
| Corretude | O software cumpre a especificação? |
| Robustez | Como reage a falhas e entradas inesperadas? |
| Extensibilidade | Quanto custa evoluir o sistema? |
| Reusabilidade | Partes podem ser reaproveitadas? |
| Compatibilidade | O sistema convive e troca dados com outros? |
| Eficiência | Usa recursos de forma adequada? |
| Usabilidade | É compreensível e utilizável pelo público previsto? |
...
| Dimensão ISO/IEC 25010 apresentada na disciplina | Foco |
| :--- | :--- |
| Adequação funcional | Funções necessárias e corretas |
| Eficiência de desempenho | Tempo, recursos e capacidade |
| Compatibilidade | Coexistência e interoperabilidade |
| Usabilidade | Aprendizado, operação e prevenção de erros |
| Confiabilidade | Disponibilidade e tolerância a falhas |
| Segurança | Proteção, integridade e autenticidade |
| Manutenibilidade | Modularidade, reuso e testabilidade |
| Portabilidade | Adaptação, instalação e substituição |
...
```mermaid
flowchart LR
    Agil["Processo ágil<br>entrega e resposta à mudança"]:::external
    Modular["Programação modular<br>coesão, baixo acoplamento e encapsulamento"]:::core
    Qualidade["Qualidade percebida<br>corretude, evolução e confiabilidade"]:::component

    Agil -->|"pressiona por mudança frequente"| Modular
    Modular -->|"reduz impacto estrutural"| Qualidade
```
