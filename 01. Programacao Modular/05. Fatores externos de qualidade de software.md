...
flowchart TD
    subgraph ISO25010 ["Fatores de Qualidade de Produto (ISO/IEC 25010)"]
        ...
        Root --> C1["1. Funcionalidade<br>(Adequação, Completude, Correção)"]
        Root --> C2["2. Desempenho<br>(Tempo de Resposta, Recursos, Capacidade)"]
        Root --> C3["3. Compatibilidade<br>(Coexistência, Interoperabilidade)"]
        Root --> C4["4. Usabilidade<br>(Aprendizado, Uso, Proteção a Erros, Estética, Acessibilidade)"]
        Root --> C5["5. Confiabilidade<br>(Maturidade, Disponibilidade, Tolerância a Falhas, Recuperabilidade)"]
        Root --> C6["6. Segurança<br>(Confidencialidade, Integridade, Não-Repúdio, Autenticidade, Responsabilidade)"]
        Root --> C7["7. Manutenibilidade<br>(Modularidade, Reusabilidade, Analisabilidade, Modificabilidade, Testabilidade)"]
        Root --> C8["8. Portabilidade<br>(Adaptabilidade, Instalabilidade, Substitutibilidade)"]
    end
```
