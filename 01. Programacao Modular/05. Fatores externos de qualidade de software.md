...
## O que são fatores externos e internos? (Técnica de Feynman)
...
### Robustez (*Robustness*) e Degradação Graciosa (*Graceful Degradation*)
...
### Facilidade de uso / Usabilidade (*Ease of Use*)
...
## Matriz comparativa: fatores de qualidade vs. impacto para o usuário
...
## O modelo formal de qualidade da ISO/IEC 25010 (PUC Minas)
...
## A ponte entre o manifesto ágil, fatores de qualidade e programação modular
...
1. **"Software em funcionamento mais que documentação abrangente" ↔ Corretude e Robustez:**
...
2. **"Responder a mudanças mais que seguir um plano" ↔ Extensibilidade e Modificabilidade:**
