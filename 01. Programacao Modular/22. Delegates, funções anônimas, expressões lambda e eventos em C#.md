...
1. **A declaração do delegate:** É o formulário do cartório que diz: *"Esta procuração só é válida para nomear alguém que assine um documento (receba um `decimal`) e devolva um comprovante (retorne um `decimal`)"*.
