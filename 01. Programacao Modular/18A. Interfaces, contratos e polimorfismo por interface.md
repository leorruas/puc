...
flowchart TD
    ...
    Contrato["IExportavel<br>Exportar()"]:::core
    Pdf["RelatorioPdf"]:::component
    Csv["RelatorioCsv"]:::component

    Cliente -->|"depende de"| Contrato
    Pdf -.->|"implementa"| Contrato
    Csv -.->|"implementa"| Contrato
```
...
## Declaração, implementação e referência por interface em C#

### Declaração da interface e implementação pela classe
...
### Variáveis tipadas pelo contrato da interface
...
## Interfaces, classes abstratas e implementação explícita

### Interface, classe abstrata e herança de classe
...
### Implementação explícita de membros de interface
...
### Limites do contrato definido por uma interface
...
## Interfaces na relação com herança, abstração e polimorfismo
