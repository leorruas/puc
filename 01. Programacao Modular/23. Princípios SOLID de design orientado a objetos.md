...
## O que é SOLID e por que ele existe? (Técnica de Feynman)
...
## Os 5 princípios em detalhes: Teoria, violação e refatoração em C#
...
#### Estudo de caso clássico: O Anúncio Publicitário e o Detector Gramatical do Conectivo "E"
...
#### Por que a classe `Anuncio` viola o SRP?
...
#### A armadilha do modelo mental do mundo real ("É UM" vs. "Comporta-se como")
...
#### O compilador não consegue detectar a quebra do LSP
...
#### As regras de Design by Contract (Bertrand Meyer) para honrar o LSP
...
#### A violação do ISP quebra o SRP:
...
#### A violação do ISP quebra o LSP:
...
#### A violação do ISP quebra o OCP e gera Acoplamento Tóxico:
...
#### A violação do ISP enfraquece o DIP:
...
#### O que significa exatamente *"Abstrações não devem depender de detalhes. Detalhes devem depender de abstrações"*?
...
#### A Abstração (Interface) deve ser neutra e agnóstica à tecnologia:
...
#### Os Detalhes concretos devem se adaptar à Abstração (A Tomada e os Eletrodomésticos):
...
#### Estudo de caso clássico: O Interruptor e os Dispositivos (A dupla violação de DIP e OCP)
...
#### Por que essa modelagem viola o DIP e o OCP ao mesmo tempo?
...
## Exemplo completo e integrado em C# (Sistema bancário aderente ao SOLID)
