...
* A notação formal $S <: T$ (lê-se: *"o tipo $S$ é um subtipo do tipo $T$"*) significa que onde quer que uma referência de tipo $T$ for solicitada, o sistema pode receber uma instância concreta de $S$ com expressa substituibilidade quando o contrato é respeitado (veja [[15. Herança (generalização, especialização e extensibilidade modular)#3. Subtipagem vs. herança: o que é a relação S <: T?|Artigo 15]] e [[Glossário de conceitos#44. Subtipagem (Subtyping / Subtype Polymorphism)|Glossário 44]]).
