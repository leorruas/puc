...
## 2. Information hiding vs. encapsulamento: qual é a diferença?

Muitos desenvolvedores confundem esses dois termos, tratando-os como sinônimos. Na teoria de software, eles operam em níveis diferentes:

```mermaid
flowchart LR
    subgraph TeoriaVersusPratica ["Conceito Arquitetural vs. Mecanismo de Linguagem"]
        direction TB
        IH["1. Information Hiding (Princípio de Design)<br>- O 'PORQUÊ' e a 'Estratégia Arquitetural'.<br>- Decisão deliberada de esconder o que pode mudar no futuro."]
        ENC["2. Encapsulamento (Mecanismo Técnico)<br>- O 'COMO' e a 'Ferramenta de Implementação'.<br>- Uso de classes, private, public e properties na sintaxe."]

        IH -->|Materializado através do| ENC
    end
```
