...
flowchart LR
    ...
    Financeiro["Empresa.Financeiro.Conta"]:::component
    Autenticacao["Empresa.Autenticacao.Conta"]:::component

    Cliente -->|"usa nome qualificado"| Financeiro
    Cliente -->|"usa nome qualificado"| Autenticacao
```
...
```mermaid
flowchart LR
    Pastas["Pastas e arquivos<br>organização física"]:::data
    Namespace["Namespace<br>organização lógica de nomes"]:::core
    Convencao["Podem seguir a mesma estrutura<br>por convenção, mas não são obrigados"]:::component
...
```mermaid
flowchart LR
    A["Pedido.cs<br>partial class Pedido"]:::data
    B["Pedido.Validacao.cs<br>partial class Pedido"]:::data
    C["Pedido.Designer.cs<br>partial class Pedido"]:::data
    Compilador["Compilador"]:::core
    Tipo["Uma definição de tipo Pedido<br>emitida no assembly"]:::component
