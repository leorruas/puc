...
## 5. Para que servem as classes parciais (*Partial Classes*)? (Técnica de Feynman)
...
Durante o processo de compilação (*build time*), o **compilador Roslyn** (*.NET Compiler Platform* — veja [[Glossário de conceitos#42 Compilador Roslyn NET Compiler Platform|Compilador Roslyn no glossário]]) analisa as Árvores de Sintaxe Abstrata (AST) de todos os arquivos do projeto simultaneamente.
...
## 6. Conexão interdisciplinar: namespaces e o Diagrama de Pacotes da UML
