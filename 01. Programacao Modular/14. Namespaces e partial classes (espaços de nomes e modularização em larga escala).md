...
## 3. Diretiva `using`, apelidos (*Aliases*) e resolução de ambiguidades
...
## 4. O que são classes parciais (*Partial Classes*)?
...
## 5. Quando usar e quais os benefícios reais de `partial classes`?
...
## 6. Regras fundamentais para o uso de `partial classes`
...
## 7. Métodos parciais (*Partial Methods*)
...
## 9. Boas práticas de arquitetura e projeto
