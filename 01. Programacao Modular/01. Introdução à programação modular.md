...
Dessa forma, provou-se que o `GOTO` não é estritamente necessário para expressar nenhuma lógica computável → [[00. Sintaxe Multilinguagem/02. Estruturas condicionais (if, else, switch)#3. O caso histórico do GOTO (Salto incondicional descontinuado)|Entenda a mecânica e a descontinuação do GOTO no Guia de Sintaxe]].
