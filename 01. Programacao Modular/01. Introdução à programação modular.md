...
```mermaid
flowchart LR
    Decompor["Decomposição<br>dividir o problema"]:::component
    Modularizar["Modularização<br>agrupar responsabilidades"]:::core
    Encapsular["Encapsulamento<br>cada módulo gerencia seu estado"]:::data

    Decompor --> Modularizar
    Modularizar --> Encapsular
```
...
```mermaid
flowchart LR
    Maquina["Código de máquina / Assembly"]:::external
    Estruturada["Programação estruturada"]:::component
    TAD["TADs e módulos"]:::data
    OO["Orientação a objetos"]:::component
    Arquiteturas["Componentes, APIs e serviços"]:::core
...
flowchart LR
    ...
    Interface -->|"aciona"| Operacoes
    Operacoes -->|"protegem"| Estado
```
