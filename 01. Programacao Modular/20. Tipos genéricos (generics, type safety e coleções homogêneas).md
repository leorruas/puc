...
## A era pré-generics: os graves problemas de `ArrayList` e coleções baseadas em `object`
...
## A solução com tipos genéricos: segurança e alta performance
...
## Sintaxe e criação de componentes genéricos
...
#### Por que usamos múltiplos tipos genéricos?
...
#### Exemplo prático: criando uma estrutura de mapeamento de múltiplos tipos
...
#### Convenções consagradas de nomenclatura: por que usar letras maiúsculas?
...
#### A fundamentação formal: teoria dos conjuntos e conjuntos disjuntos (*Disjoint Sets*)
...
## Restrições em tipos genéricos (*Generic Constraints - `where T : ...`*)
...
## O catálogo das principais coleções genéricas do .NET
...
## Exemplo completo e integrado em C# (Sistema de gerenciamento logístico com Generics)
