...
### O que é uma classe abstrata? (A intuição da técnica de Feynman)
...
### Sintaxe e regras fundamentais no C#
...
#### Na sintaxe do código (Proibição do operador `new`):
...
#### Na arquitetura de memória (Proteção do runtime):
...
#### Diferença vital: Instanciar um objeto vs. Declarar uma referência:
...
### O padrão arquitetural Template Method (O método gabarito)
...
### Exemplo completo e integrado em C# (Sistema geométrico e cálculo de áreas)
...
### Por que usar classes abstratas? (O salto de design)
...
### Matriz comparativa: Classe Concreta vs. Classe Abstrata vs. Interface
...
### O impacto no polimorfismo e em programas genéricos
...
### Quando usar e quando não usar classes abstratas? (Guia prático de decisão)
...
### Boas práticas no design de classes abstratas
