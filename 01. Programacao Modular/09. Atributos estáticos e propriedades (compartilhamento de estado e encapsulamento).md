...
# Atributos estáticos e propriedades (compartilhamento de estado e encapsulamento)
...
**Modelo mental de instância e classe.**
...
### Exemplo integrado de estado compartilhado
...
## Estado compartilhado, contratos e riscos de `static`
...
### Estado compartilhado e invariantes
...
### Limites e cuidados com membros estáticos
...
### Instância e classe: comparação de responsabilidades
...
### `get`, `set` e controle de acesso ao estado
...
### Propriedades completas, automáticas e estáticas
...
**Comparação entre estilos de propriedade.**
