...
Um **membro estático (*Static Member*)** é qualquer componente estrutural de uma classe (campo, método, propriedade, evento ou construtor) declarado com a palavra-chave **`static`**, vinculando sua existência, alocação de memória e ciclo de vida diretamente ao **tipo/classe em si**, e **não a uma instância individual no *Heap*** $\rightarrow$ [[Glossário de conceitos#15 Membro estático Static Member|Membro Estático no Glossário]].
