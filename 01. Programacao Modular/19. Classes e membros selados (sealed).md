...
#### 1. Uma classe abstrata pode ser selada (`abstract sealed class`)?
...
#### 2. Uma classe abstrata pode ter métodos selados (`sealed override`)?
* **SIM, com certeza!**
* **Como funciona?**
...
### 7. Matriz comparativa dos modificadores de herança
...
### 8. Exemplo completo e integrado em C# (Sistema financeiro de pagamentos e segurança)
...
### 6. Classe privada vs. classe selada (*Private vs. Sealed*)
...
### 9. Quando usar e quando não usar `sealed`? (Guia de boas práticas)
