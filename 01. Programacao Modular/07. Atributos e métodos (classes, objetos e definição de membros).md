...
### a. O Molde da Classe
* **[[Glossário de conceitos#3 Classe Class|Classe (Class)]]:** É o molde, modelo ou especificação abstrata que define um novo [[Glossário de conceitos#1 Tipo Type|Tipo de Dado]] no programa. A classe não ocupa espaço de processamento de dados em si; ela apenas descreve a estrutura → [[00. Sintaxe Multilinguagem/05. Abstração e encapsulamento com classes (TADs)|Sintaxe Comparada de Classes]].
```csharp
