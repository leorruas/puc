...
**Classe e objeto como modelo mental.**
...
**O molde da classe.**
* **[[Glossário de conceitos#Classe Class|Classe (Class)]]:** É o molde, modelo ou especificação abstrata que define um novo [[Glossário de conceitos#Tipo Type|Tipo de Dado]] no programa. Declarar a classe não cria uma conta; o runtime, porém, mantém metadados do tipo, código dos métodos e eventual estado estático → [[00. Sintaxe Multilinguagem/05. Abstração e encapsulamento com classes (TADs)|Sintaxe Comparada de Classes]].
```csharp
...
**Atributos e declaração de estado.**
* **[[Glossário de conceitos#Atributo Attribute Field|Atributo (Field / Data Member)]]:** São as variáveis internas declaradas na classe que armazenam o **[[Glossário de conceitos#Estado State|Estado (State)]]** (a fotografia dos valores em um dado instante).
* **[[Glossário de conceitos#Declaração em Computação Declaration Declarar|Declaração (Declaration)]]:** O ato técnico de apresentar os nomes e tipos dos membros ao compilador (`private double _saldo;`), reservando sua identidade e tipo.
```csharp
public class ContaCorrente
{
...
* **[[Glossário de conceitos#Método Method|Método (method / member function)]]:** São as sub-rotinas ([[02. Funções e procedimentos|Funções e procedimentos]]) que definem o **comportamento** do objeto, sendo o canal legítimo para consultar e modificar o estado encapsulado.
```csharp
...
**Instanciação de objetos na memória.**
...
### Estado e comportamento dentro da classe
...
## Atributos, métodos, parâmetros e variáveis locais em C#
...
### Declaração de atributos e métodos em C#
...
### Atributos, variáveis locais e parâmetros
...
**Parâmetro e atributo na mesma operação.**
...
## Referências, objetos e instanciação na memória
...
### Limites do modelo simplificado de memória
...
### Referência e objeto são coisas diferentes
...
### `new`, alocação e chamada do construtor
...
## Visibilidade e boas práticas dos membros
...
### `protected` e acesso em hierarquias de classes
...
### Boas práticas para estado e comportamento
