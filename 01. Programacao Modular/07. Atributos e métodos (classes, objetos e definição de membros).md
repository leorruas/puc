...
Um objeto é uma instância de uma Classe que possui um nome, identidade e uma **posição física na memória**. Nessa posição de memória são armazenados os valores de seus atributos. Classes podem gerar múltiplas instâncias de objetos independentes.
...
## 5. Diferenças conceituais: atributos vs. variáveis locais
...
## 6. Modificadores de acesso: o papel especial do `protected`
...
## 7. Boas práticas na definição de atributos e métodos
