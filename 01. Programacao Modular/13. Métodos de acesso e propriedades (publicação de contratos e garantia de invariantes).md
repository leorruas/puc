...
## Estado privado e contratos de acesso
...
### Atributos privados e operações públicas
...
### Quando expor leitura ou escrita de um atributo
...
## Métodos de acesso e propriedades em C#
...
### Propriedades automáticas, somente leitura, `init` e calculadas
...
### Validação e restrição de mutação nas propriedades
...
**`private set` e mutação controlada.**
...
### Exemplo integrado de propriedades e invariantes
...
## Imutabilidade, nomenclatura e escolha entre campos, métodos e propriedades
...
### Escrita restrita e imutabilidade não são equivalentes
...
### `PascalCase`, `camelCase` e `_underscore` em C#
...
### Campos, métodos e propriedades: responsabilidades diferentes
...
## Encapsulamento e invariantes por meio de propriedades
...
**Modelo mental do caixa bancário.**
...
### Boas práticas para expor estado
