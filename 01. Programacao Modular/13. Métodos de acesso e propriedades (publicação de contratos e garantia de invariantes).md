...
## 3. As duas abordagens de implementação no C#
...
## 4. Tipos e variações de propriedades no C#
...
## 5. Convenções de nomenclatura no C#: `PascalCase` vs. `camelCase` vs. `_underline`
...
## 6. Matriz comparativa: campos vs. métodos vs. propriedades
...
## 9. Boas práticas de projeto com métodos de acesso
