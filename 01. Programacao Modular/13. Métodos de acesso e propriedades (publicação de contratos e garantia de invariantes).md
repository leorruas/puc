...
É o padrão herdado do Java e C++, onde declaramos duas funções públicas explícitas (veja o guia de sintaxe em [[00. Sintaxe Multilinguagem/07. Getters, setters e propriedades (acesso e modificação de estado)|07. Getters, setters e propriedades]]):
