...
### 9. Nota fundamental: estamos falando de herança ou composição?
...
Para entender quando e por que escolher composição em vez de herança, consulte o [[15. Herança (generalização, especialização e extensibilidade modular)#10. Por que favorecer composição sobre herança? (Favor Composition Over Inheritance)|Artigo 15 (Seção 10: Favorecer composição sobre herança)]].
