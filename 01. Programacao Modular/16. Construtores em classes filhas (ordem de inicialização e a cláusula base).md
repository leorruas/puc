...
## 3. A sintaxe da cláusula `: base(...)` no C#

No C#, a invocação do construtor da superclasse é feita usando o operador de dois-pontos (`:`) seguido da palavra-chave `base` e da lista de argumentos:
...
public class Veiculo 
{
    ...
    // Construtor parametrizado que protege as invariantes da base:
...
public class Caminhao : Veiculo 
{
    ...
    // O construtor do Caminhão recebe TODOS os dados necessários e repassa a parte básica para o pai:
    public Caminhao(string placa, string modelo, int anoFabricacao, double capacidadeCarga, int eixos)
        : base(placa, modelo, anoFabricacao) // DELEGAÇÃO OBRIGATÓRIA PARA O PAI
    {
