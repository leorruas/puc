...
flowchart LR
    ...
    CamposFilha["Inicializadores de campo<br>da classe derivada"]:::data
    Base["Cadeia de inicialização<br>e construtor da base"]:::component
    CorpoFilha["Corpo do construtor<br>da derivada"]:::component
    Pronto["Objeto pronto"]:::core
...
```mermaid
flowchart LR
    Chamada["new Caminhao(...)"]:::external
    Filha["Construtor Caminhao<br>recebe todos os argumentos"]:::core
    Base["base(placa, modelo, ano)"]:::component
    Veiculo["Construtor Veiculo<br>inicializa parte herdada"]:::component
    Corpo["Corpo de Caminhao<br>inicializa carga e eixos"]:::data
...
```mermaid
flowchart LR
    Conveniente["Caminhao(placa, modelo, ano)"]:::component
    Canonico["Caminhao(placa, modelo, ano, capacidade, eixos)"]:::core
    Base["Veiculo(placa, modelo, ano)"]:::component

    Conveniente -->|"this(...)"| Canonico
    Canonico -->|"base(...)"| Base
```
