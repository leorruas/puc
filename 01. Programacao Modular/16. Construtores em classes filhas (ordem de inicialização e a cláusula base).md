...
### Como funciona a inicialização de classes filhas? (Técnica de Feynman)
...
### Por que construtores NÃO são herdados?
...
### Como propagar argumentos da classe filha para o construtor da classe pai
...
### O que acontece quando a classe pai NÃO tem construtor padrão?
...
### Combinando `: base(...)` e `: this(...)` (Sobrecarga inteligente)
...
### Reflexão: o impacto dos construtores na correção e robustez do sistema
...
#### A classe base consegue garantir a qualidade mesmo nestas situações?
...
### A regra crítica: métodos virtuais dentro de construtores
...
### Boas práticas de inicialização em hierarquias
...
### Nota fundamental: estamos falando de herança ou composição?
