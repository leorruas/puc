...
## A origem histórica e a Gang of Four (GoF)
...
## Os dois princípios centrais de POO por trás dos padrões GoF
...
## Os três grandes grupos de padrões GoF
...
### A matriz de classificação GoF (Escopo vs. Propósito)
...
## Exemplo completo e integrado: Combinando Singleton, Strategy e Observer em C#
...
## Resumo conceitual e mapa de decisão
