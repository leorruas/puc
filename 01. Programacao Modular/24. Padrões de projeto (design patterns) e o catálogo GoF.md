...
flowchart LR
    Nome["Nome"]:::component
    Problema["Problema e contexto"]:::component
    Solucao["Estrutura da solução"]:::core
    Consequencias["Consequências e trade-offs"]:::component

    Nome --> Problema
    Problema --> Solucao
    Solucao --> Consequencias
```
...
```mermaid
flowchart TD
    GoF["Princípios recorrentes no GoF"]:::core
    Interface["Programar para interfaces<br>em vez de implementações concretas"]:::component
    Composicao["Favorecer composição<br>quando ela reduz acoplamento"]:::component
...
```mermaid
flowchart TD
    GoF["Catálogo GoF<br>23 padrões"]:::core
    Criacionais["Criacionais<br>criação de objetos"]:::component
    Estruturais["Estruturais<br>composição de estruturas"]:::component
    Comportamentais["Comportamentais<br>colaboração entre objetos"]:::component
