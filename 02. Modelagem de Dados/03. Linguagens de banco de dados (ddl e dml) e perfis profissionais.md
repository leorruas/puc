...
| :--- | :--- | :--- |
| DDL | Definir estruturas e restrições | `CREATE`, `ALTER`, `DROP` |
| DML / DQL | Consultar e alterar dados | `SELECT`, `INSERT`, `UPDATE`, `DELETE` |
...
| Aspecto | DML procedural | DML declarativa / não procedural |
| :--- | :--- | :--- |
| O programador informa | O resultado e o caminho de navegação | O resultado desejado |
| Quem decide o acesso | O próprio programa | O SGBD e seu otimizador |
| Exemplo de contexto | Modelos hierárquicos e em rede | Modelo relacional e SQL |
...
```mermaid
flowchart TD
    Usuarios["Usuários finais"]:::external
    Dev["Engenharia de software<br>requisitos e implementação"]:::component
    AD["Administrador de Dados<br>modelo conceitual e corporativo"]:::core
    DBA["DBA<br>implementação, operação e desempenho"]:::data
