...
## Extensões do MER para estruturas mais complexas
...
**A metáfora do depósito bancário.**
...
**Anatomia e representação gráfica no DER de Chen.**
...
## Atributos em relacionamentos $N:M$ e relacionamentos ternários
...
**Relacionamentos ternários e decisões de modelagem.**
...
**Leitura do relacionamento ternário.**
...
**Ternário ou múltiplos binários?**
...
## Supertipos, subtipos e especialização
...
### Disjunção, sobreposição, totalidade e parcialidade
...
**Exemplo de funcionário com duas especializações.**
...
## Supertipos e subtipos na relação com orientação a objetos
