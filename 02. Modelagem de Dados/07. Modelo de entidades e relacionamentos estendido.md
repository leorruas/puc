...
flowchart TD
    ...
    Regra["d<br>especialização disjunta"]:::warning
    Carro["CARRO<br>numero_passageiros, velocidade_maxima"]:::component
    Caminhao["CAMINHÃO<br>numero_eixos, capacidade_peso"]:::component
...
> **Leitura de Feynman:** é como retirar informações repetidas de duas fichas e colocá-las em uma ficha-mãe. As fichas de `CARRO` e `CAMINHÃO` passam a guardar apenas o que realmente as diferencia.
