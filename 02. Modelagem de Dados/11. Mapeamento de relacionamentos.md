...
## Relacionamentos do DER no esquema relacional
...
## Cardinalidade, participação e atributos no mapeamento
...
## Relacionamentos binários: 1:1, 1:N e N:N
...
**Só a FK é suficiente para garantir 1:1?**
...
**E os atributos de um relacionamento 1:1?**
...
**Atributos de relacionamento em 1:N.**
...
**As duas FKs viram uma PK composta?**
...
**A PK do N:N é sempre exatamente as duas FKs?**
...
**Onde ficam os atributos do relacionamento N:N?**
...
**A PK de um relacionamento N-ário usa todas as FKs?**
...
**Um relacionamento ternário pode sempre ser quebrado em binários?**
...
## Regras de mapeamento por cardinalidade
...
## Generalização e especialização no modelo relacional
...
No DER, `CARRO` e `CAMINHAO` herdam os atributos de `VEICULO`. No modelo relacional não existe uma única tradução obrigatória. Há três estratégias principais.

### Estratégia de tabela única para toda a hierarquia
...
### Estratégia com apenas tabelas para os subtipos
...
### Estratégia com supertipo e subtipos em tabelas separadas
...
### Totalidade, parcialidade, disjunção e sobreposição
...
## Cardinalidade, participação e identidade na escolha do mapeamento
