...
## A analogia de Feynman: as gavetas trancadas vs. a biblioteca centralizada
...
## A distinção fundamental: BD vs. SGBD vs. SBD
...
### Banco de dados ou base de dados (*o repositório de dados*)
...
### Sistema Gerenciador de Banco de Dados — SGBD (*o software de controle*)
...
### Sistema de Banco de Dados — SBD (*o ecossistema completo*)
...
## Para quem existe o banco de dados? A comunidade de atores
...
## As patologias da abordagem de arquivos vs. as vantagens do banco de dados
...
## O conceito de mini-mundo: a realidade modelada
...
* **Próximo artigo:** [[03. Linguagens de banco de dados (ddl e dml) e perfis profissionais]]
