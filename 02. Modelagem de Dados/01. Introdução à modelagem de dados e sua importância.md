...
```mermaid
flowchart LR
    Dado["Dado<br>39,5"]:::data
    Informacao["Informação<br>paciente com febre de 39,5 °C"]:::component
    Conhecimento["Conhecimento e ação<br>interpretar e decidir conduta"]:::core

    Dado -->|"ganha contexto"| Informacao
    Informacao -->|"é interpretada"| Conhecimento
```
...
```mermaid
flowchart LR
    Dominio["Domínio do problema<br>regras, entidades e restrições"]:::external
    Conceitual["Modelo conceitual<br>entidades, atributos e relacionamentos"]:::core
    Logico["Modelo lógico<br>relações, PK, FK e normalização"]:::data
    Fisico["Modelo físico<br>armazenamento, índices e partições"]:::component
...
```mermaid
flowchart LR
    Requisitos["Engenharia de requisitos<br>necessidades e regras"]:::external
    Modelagem["Modelagem de dados<br>DER e restrições"]:::core
    POO["Programação orientada a objetos<br>classes de domínio"]:::component
    SQL["Persistência SQL<br>DDL, DML, PK e FK"]:::data
...
```mermaid
flowchart LR
    Necessidade["Necessidades do mundo real"]:::external
    Requisitos["Elicitação e análise"]:::component
    Conceitual["Modelo conceitual"]:::core
    Logico["Modelo lógico"]:::data
    Fisico["Modelo físico e DDL"]:::component
    SGBD["SGBD em operação"]:::data
