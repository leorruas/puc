...
# 1ª e 2ª formas normais: atomicidade, dependências funcionais e redução de redundância

> **Contexto:** Sessão da PUC Minas que inicia o estudo da normalização de bancos de dados. O foco está em compreender por que relações mal estruturadas geram redundância e anomalias e em aplicar a 1ª Forma Normal (1FN) e a 2ª Forma Normal (2FN) usando atributos atômicos, chaves e dependências funcionais.
...
## 8. A 1FN e o modelo relacional formal
...
## 9. O conceito que prepara a 2FN: dependência funcional
...
## 10. Dependência funcional não é causalidade
...
## 11. Chave e dependência funcional
...
## 12. O exemplo da aula para a 2FN
...
## 13. Quais dependências existem nessa tabela?
...
## 14. O que é dependência parcial?
...
## 16. A 2FN só existe quando a PK é composta?
...
## 17. Como normalizar o exemplo para a 2FN
...
## 18. O que foi removido da tabela original?
...
## 19. As anomalias desaparecem no exemplo normalizado
...
## 21. Um procedimento para resolver exercícios de 2FN
...
## 22. Um diagrama das dependências do exemplo
...
* ELMASRI; NAVATHE. Referência citada no material da disciplina, 2010.
