...
> **Contexto:** Este artigo introduz o projeto de bancos de dados relacionais a partir do modelo relacional de Edgar F. Codd, conectando a passagem do esquema conceitual para estruturas tabulares aos conceitos de relação, tupla, atributo, domínio, esquema de relação, instância, chave candidata, chave primária, chave alternativa e chave composta.

---

## DER, relações e passagem ao modelo relacional
...
## Modelo relacional: origem e significado
...
## Estrutura, instância, domínio e valores nulos
...
**Instância de uma relação: os dados existentes agora.**
...
**Domínio: quais valores fazem sentido para um atributo?**
...
## Chaves e identificação de tuplas
...
## Esquema relacional e implementação em SQL

Considere um esquema relacional composto por relações como:
...
A disciplina de [[03. Manipulação de Dados SQL/00. Manipulação de Dados SQL - Resumo|Manipulação de dados SQL]] trabalha justamente com a camada em que essas decisões passam a ser expressas na linguagem do SGBD.
