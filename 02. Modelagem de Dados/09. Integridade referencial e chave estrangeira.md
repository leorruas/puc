...
## Do relacionamento do DER para a chave estrangeira
...
## Relação referenciada e relação referenciadora
...
## Toda tabela precisa ter chave primária?
...
## As quatro integridades lado a lado
...
## O que acontece em uma inclusão?
...
## O que acontece em uma exclusão?
...
## RESTRICT e NO ACTION são sempre iguais?
...
## O que acontece em uma alteração?
...
## Matriz das operações e restrições
...
## A dependência entre departamento e empregado
...
## Do relacionamento conceitual para a regra relacional
