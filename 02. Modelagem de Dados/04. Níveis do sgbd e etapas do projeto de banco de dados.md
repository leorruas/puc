...
## As analogias de Feynman: o restaurante e o projeto automotivo
...
## Os três níveis de abstração do SGBD (ANSI/SPARC)
...
## Os mapeamentos entre níveis e a independência de dados
...
## Esquema vs. instância do banco de dados
...
## As etapas completas do projeto de banco de dados
