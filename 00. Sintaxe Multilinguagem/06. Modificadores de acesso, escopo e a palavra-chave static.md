...
## Desconstrução dos cabeçalhos em C# (técnica de Feynman)
...
## Componentes da classe principal (`class Program`, `void`, `Main`)
...
## Por que o Construtor precisa de `_saldo = saldoInicial;` e `_criacao = criacao;`?
...
## A palavra-chave `static`: membro da classe vs. membro da instância
...
## Quando usar `static` e quando NÃO usar?
...
## Combinações de visibilidade e escopo
...
## Comparativo multilinguagem (`static` e importações)
