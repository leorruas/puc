...
> **Contexto:** Estudo detalhado dos componentes de cabeçalho em C# e Java (`using System`, `class`, `return`, `static void Main`), com foco no papel do modificador `static`, visibilidade (`public` vs `private`) e o uso da Técnica de Feynman.
...
2. **`class Program` (A Planta da Casa):**
   - **Analogia:** É o molde que define o módulo. Em C#, todo código deve obrigatoriamente estar dentro de uma `class`.
