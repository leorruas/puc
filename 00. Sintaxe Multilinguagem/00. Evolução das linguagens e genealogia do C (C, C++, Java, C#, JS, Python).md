...
# Evolução das linguagens e genealogia do C (C, C++, Java, C#, JS, Python)
...
## A árvore genealógica da família C (Técnica de Feynman)
...
```mermaid
flowchart TD
    subgraph Raiz ["Origem: Baixo Nível e Ponteiros"]
        C["Linguagem C (1972)<br>Estruturada e Procedural"]
    end

    subgraph RamoPOO ["Evolução: Orientação a Objetos"]
        CPP["C++ (1983)<br>Classes e Alta Performance"]
        JAVA["Java (1995)<br>JVM e Garbage Collector"]
        CSHARP["C# (2000)<br>.NET e Propriedades"]
        C --> CPP
        CPP --> JAVA
        JAVA --> CSHARP
    end

    subgraph RamoDinamico ["Evolução: Dinamismo e Produtividade"]
        PYTHON["Python (1991)<br>Legibilidade e Multiparadigma"]
        JS["JavaScript (1995)<br>A Linguagem da Web"]
        C --> PYTHON
        C --> JS
    end
```
...
## Linha do tempo e motivação de cada evolução
...
## O que é o Garbage Collector? (Técnica de Feynman)
