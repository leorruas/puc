...
## O que são funções de primeira classe? (Técnica de Feynman)
...
## Comparativo multilinguagem: Anatomia das Expressões Lambda
...
## O que é uma função anônima e como ela se diferencia da expressão lambda?
...
## O padrão de Callback (Função de Retorno) nas 4 linguagens
...
## O padrão de Hook e Unhook (Enganchar e Desenganchar Eventos)
