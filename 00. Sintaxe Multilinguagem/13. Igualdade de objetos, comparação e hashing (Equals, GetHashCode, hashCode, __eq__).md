...
## A intuição da igualdade (Técnica de Feynman)
...
## A conexão direta com o [[01. Programacao Modular/20. Tipos genéricos (generics, type safety e coleções homogêneas)|Artigo 20 (Tipos Genéricos)]]
...
## O que é uma função de hashing (*Hash Function*) e como ela funciona?
...
## As 4 regras de ouro da equivalência matemática
