...
graph TD
    ...
    subgraph Par6 ["6. Hierarquia em Ramos"]
        TREE["Modelo Mental:<br>Árvore Binária (Classificação e Busca)"]
        TN["Código Estrutural:<br>Classe Node com Esquerda / Direita"]
        TREE --> TN
    end

    subgraph Par7 ["7. Conexões em Rede"]
        NET["Modelo Mental:<br>Grafo (Vértices e Arestas)"]
        GN["Código Estrutural:<br>Dictionary com Lista de Vizinhos"]
        NET --> GN
    end
```
