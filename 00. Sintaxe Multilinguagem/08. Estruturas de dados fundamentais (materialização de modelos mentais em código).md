...
## Do modelo mental ao código (Técnica de Feynman)
...
## Tabela comparativa geral de materialização
...
## Conexões com engenharia de requisitos e design de interação
...
## Arquitetura de coleções no .NET: `System.Collections` vs. `Generic` vs. `Concurrent`
